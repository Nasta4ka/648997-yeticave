...
<div class="page-wrapper">
    ...
    <main>
        ...
        <form class="form container <?= count($errors) > 0 ? 'form--invalid' : ''; ?> " action="sign_up.php" method="post" enctype="multipart/form-data"> <!-- form--invalid -->
            ...
            <div class="form__item  <?= isset($errors['name']) ? 'form__item--invalid' : ''; ?>">
                ...
                <input id="name" type="text" name="name" placeholder="Введите имя"  value="<?= isset($user['name']) ? esc($user['name']) : ''  ?>">
            ...
            <span class="form__error form__error--bottom"><?= count($errors) > 0 ? $errors['bottom'] : ''; ?></span>
